...
export default function PartnersSection() {
  ...
  return (
    <div id="partners" className="relative min-h-screen flex flex-col items-center text-white justify-center gap-12 bg-[#000091] z-50">
      ...
      <div className="container relative h-screen py-40 px-4 md:px-0 flex flex-col justify-center">
        ...
        <div className="flex flex-row gap-4 py-8">
            <Button className="bg-white text-black px-12 py-8 rounded-none font-bold hover:bg-white/80 cursor-none">Contact Us</Button>
        </div>
